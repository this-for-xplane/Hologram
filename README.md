...
Aero Hologram UI는 물리적인 홀로그램 스티커의 질감과 빛 반사 효과를 웹 환경에서 정교하게 재현하려 노력중안 인터랙티브 디자인 프로젝트임. 단순한 그래픽 구현을 넘어 기기의 자이로스코프 센서 또는 커서 데이터와 실시간 연동되어 입체적인 시각 경험을 제공함.
...
## 알려진 문제
• 기기들에서 꼭 버튼 터치 후 기기 권한을 허용해야 사용이 가능함. 권한 허용 없이 우회방법을 찾는중.
